...
import { MapPin, LogOut, Settings, BarChart, DollarSign, Briefcase, Menu } from "lucide-react"
...
export default function SchoolDashboardLayout({ children }) {
  ...
  const navItems = [
    { name: "Statistics", path: "/school/dashboard", icon: BarChart },
    { name: "Profile", path: "/school/dashboard/profile", icon: Settings },
    { name: "About", path: "/school/dashboard/pricing", icon: DollarSign },
    // { name: "Services", path: "/school/dashboard/services", icon: Briefcase },
  ]
      ...
      <div className="flex-1 flex flex-col">
        <header className="sticky top-0 z-10 bg-white border-b h-16 flex items-center px-4 md:px-6">
          ...
          <div className="ml-auto flex items-center gap-4">
            <span className="text-sm font-medium">Fahrschule Mustermann</span>
