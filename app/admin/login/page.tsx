...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Für Demonstrationszwecke, fest codierte Admin-Zugangsdaten
    if (email === "admin@fahrschulfinder.de" && password === "Admin!@#$1234") {
      // Simulierte API-Aufruf
      setTimeout(() => {
        ...
        <Card className="border-none shadow-lg">
          <CardHeader className="bg-rose-500 text-white rounded-t-lg">
            ...
            <CardDescription className="text-rose-100">
              Zugriff auf das Admin-Dashboard zur Verwaltung von Fahrschulen und Nutzern
            </CardDescription>
          </CardHeader>
